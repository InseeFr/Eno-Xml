...
<xsl:template match="pogues:Unit" mode="conversion-table">
    ...
    <xsl:template match="pogues:Expression | pogues:Formula | pogues:Response | 
        pogues:Maximum[parent::pogues:Loop] | pogues:Minimum[parent::pogues:Loop]  | pogues:maximum[parent::pogues:Loop] | pogues:minimum[parent::pogues:Loop] | pogues:size[parent::pogues:Loop] |
        pogues:Filter[parent::pogues:Loop] | pogues:FixedLength | pogues:value[../pogues:type='VTL']" mode="enopogues:get-ip-id">
        <xsl:param name="index" tunnel="yes"/>
        <xsl:choose>
            <xsl:when test="name() = 'Minimum' or name() = 'minimum'"><xsl:value-of select="concat(enopogues:get-id(parent::pogues:Loop), '-MIN-IP-', $index)"/></xsl:when>
            <xsl:when test="name() = 'Maximum' or name() = 'maximum' or name() = 'size'"><xsl:value-of select="concat(enopogues:get-id(parent::pogues:Loop), '-IP-', $index)"/></xsl:when>
    ...
    <xsl:template match="pogues:Expression | pogues:Formula | pogues:Text | pogues:Control/pogues:FailMessage | pogues:Label | 
        pogues:Loop/pogues:Maximum | pogues:Loop/pogues:Minimum |pogues:Loop/pogues:maximum | pogues:Loop/pogues:minimum | pogues:Loop/pogues:size |
        pogues:Loop/pogues:Filter | pogues:OccurrenceLabel | pogues:OccurrenceDescription | pogues:Unit | pogues:FixedLength | 
        pogues:value[../pogues:type='VTL'] | pogues:Description | pogues:conditionFilter | pogues:conditionReadOnly" mode="enopogues:get-related-variable">
    ...
    <xsl:template match="pogues:Declaration/pogues:Text | pogues:Control/pogues:FailMessage | pogues:Label | pogues:OccurrenceLabel | pogues:OccurrenceDescription | pogues:Unit[../pogues:IsDynamicUnit='true'] | pogues:FixedLength | pogues:value[../pogues:type='VTL'] | pogues:Description | pogues:conditionFilter | pogues:conditionReadOnly" mode="id-variable">
